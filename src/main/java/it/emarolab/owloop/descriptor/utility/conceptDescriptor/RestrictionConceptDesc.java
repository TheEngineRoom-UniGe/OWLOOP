...
public class RestrictionConceptDesc
    ...
    public RestrictionConceptDesc(OWLClass instance, OWLReferences onto) {
        super(instance, onto);
    }
    public RestrictionConceptDesc(String instanceName, OWLReferences onto) {
        super(instanceName, onto);
    }
    public RestrictionConceptDesc(OWLClass instance, String ontoName) {
        super(instance, ontoName);
    }
    public RestrictionConceptDesc(OWLClass instance, String ontoName, String filePath, String iriPath) {
        super(instance, ontoName, filePath, iriPath);
    }
    public RestrictionConceptDesc(OWLClass instance, String ontoName, String filePath, String iriPath, boolean bufferingChanges) {
        super(instance, ontoName, filePath, iriPath, bufferingChanges);
    }
    public RestrictionConceptDesc(String instanceName, String ontoName) {
        super(instanceName, ontoName);
    }
    public RestrictionConceptDesc(String instanceName, String ontoName, String filePath, String iriPath) {
        super(instanceName, ontoName, filePath, iriPath);
    }
    public RestrictionConceptDesc(String instanceName, String ontoName, String filePath, String iriPath, boolean bufferingChanges) {
    ...
    @Override
    public RestrictionConceptDesc getDisjointConceptDescriptor(OWLClass instance, OWLReferences ontology) {
        return new RestrictionConceptDesc( instance, ontology);
    }
    ...
    // Is used by the descriptors's build() method. It's possible to change the return type based on need.
    @Override
    public RestrictionConceptDesc getEquivalentConceptDescriptor(OWLClass instance, OWLReferences ontology) {
        return new RestrictionConceptDesc( instance, ontology);
    }
