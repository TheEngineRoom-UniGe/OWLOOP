...
public class MORFullConceptTest {
    ...
    // todo solve problem on concept_compoundDescriptor definition
    ...
    public void subTest() throws Exception{
        ...
        concept.writeSemantic();
        assertSemantic();
        System.out.println( "described concept_compoundDescriptor, sub test: " + concept.buildSubConcept());
    }
    ...
    public void superTest() throws Exception{
        ...
        concept.writeSemanticInconsistencySafe();
        assertSemantic();
        System.out.println( "described concept_compoundDescriptor, super test: " + concept.buildSuperConcept());
    }
    ...
    public void disjointTest() throws Exception{
        ...
        concept.writeSemantic();
        assertSemantic();
        System.out.println( "described concept_compoundDescriptor, disjoint test: " + concept.buildDisjointConcept());
    }
    ...
    public void equivalentTest() throws Exception{
        ...
        concept.writeSemanticInconsistencySafe();
        assertSemantic();
        System.out.println( "described concept_compoundDescriptor, equivalent test: " + concept.buildEquivalentConcept());
    }
    ...
    public void defineTest() throws Exception{
        ...
        concept.writeSemanticInconsistencySafe(); // the reasoner always infers here
        assertSemantic();
        System.out.println( "described concept_compoundDescriptor, definition test: " + concept.getDefinitionConcept());
    }
    ...
    public void classifyTest() throws Exception{
        ...
        concept.readSemantic();
        System.out.println( "described concept_compoundDescriptor, equivalent test: " + concept.buildIndividualClassified());
